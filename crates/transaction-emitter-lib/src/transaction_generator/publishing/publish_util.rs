...
impl PackageHandler {
    ...
    pub fn pick_package(&mut self, rng: &mut StdRng, publisher: &mut LocalAccount) -> Package {
        ...
        let tracker = self.packages.get_mut(idx).expect("PackageTracker must exisit");
...
fn update(
    ...
    for module in modules {
        ...
        let module_handle = new_module
            .module_handles.get(module.self_handle_idx().0 as usize)
...
fn publish_transaction(
    ...
    info!("PublishPackage- create_publish_transaction");
